...
contract UniswapV2Test is Test {
    ...
    function testLog() public {
        emit log_named_bytes32("factory code hash", factory.getPairCodeHash());
    ...
    function logReserves() public {
        ...
        uint256 rootK = MathUpgradeable.sqrt(reserve0 * reserve1);
        uint256 rootKLast = MathUpgradeable.sqrt(pairContract.kLast());
